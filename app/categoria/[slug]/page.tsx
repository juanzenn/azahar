...
export async function generateMetadata({
  ...
  return pageMetadata({
    ...
    // The category's own hero, which is the landscape image of the set — the one
    // shape Open Graph actually wants. Optional on the type, so a category
    // without one simply shares without an image.
    ...(category.heroImage && {
